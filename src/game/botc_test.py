...
from .clocktower_api import ClockTowerAPI, MockClockTowerAPI
...
class BotCTestSuite:
    ...
    async def _test_polling_mode(self) -> bool:
        ...
        try:
            ...
            if not hasattr(api, 'connection_mode') or api.connection_mode != "enhanced_polling":
                return False
    ...
    async def _test_adapter_features(self) -> bool:
        ...
        try:
            ...
            required_fields = [
                "platform", "connection_mode", "websocket_active",
                "polling_active", "supported_features"
            ]
