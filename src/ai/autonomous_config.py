...
from ..core.timing_config import TimingConfig, PacingStyle
...
class SpeechRecognitionConfig:
    ...
    def __post_init__(self):
        if self.wake_words is None:
            self.wake_words = [
                "storyteller", "choose", "nominate", "vote", 
                "fortune teller", "empath", "question"
            ]
