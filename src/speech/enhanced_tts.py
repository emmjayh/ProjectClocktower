...
class OpenAITTS:
    ...
    async def _generate_speech(self, text: str, voice: str, speed: float) -> Optional[bytes]:
...
class EnhancedNominationHandler:
    ...
    def __init__(self, use_openai_tts: bool = False, openai_api_key: Optional[str] = None):
        self.logger = logging.getLogger(__name__)
    ...
    async def process_nomination_speech(self, speech_text: str, active_players: list) -> Dict[str, Any]:
    ...
    def _find_closest_player(self, spoken_name: str, active_players: list) -> Optional[str]:
        ...
        for player in active_players:
            ...
            # Check similarity
            similarity = SequenceMatcher(None, spoken_name.lower(), player_name.lower()).ratio()
    ...
    async def announce_nomination(self, nominator: str, nominee: str, voice: str = "alloy"):
