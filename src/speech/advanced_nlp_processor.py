...
class IntentClassifier:
    ...
    def __init__(self):
        ...
        self.intent_patterns = {
            Intent.NOMINATE: [
                ...
                (r"nominate (\w+)", 0.90),
                (
                    r"i (?:vote for|choose) (\w+) (?:for execution|to (?:die|be executed))",
                    0.85,
                ),
    ...
    def _adjust_confidence(
        self, base_confidence: float, text: str, pattern: str
    ) -> float:
...
class ContextAwareProcessor:
    ...
    def parse_command(self, text: str) -> ParsedCommand:
        ...
        return ParsedCommand(
            ...
            metadata={"phase": self.current_phase, "character": self.current_character},
        )
    ...
    def _validate_with_context(
        self, entities: Dict[str, Any], intent: Intent, confidence: float
...
class AdvancedNLPProcessor:
    ...
    def process_speech(
        self, text: str, game_state: Dict[str, Any] = None
    ) -> ParsedCommand:
        ...
        # Validate command
        if game_state:
            is_valid, validation_message = self.validator.validate_command(
                parsed, game_state
            )
