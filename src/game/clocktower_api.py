...
class ClockTowerAPI:
    ...
    async def send_storyteller_action(self, action_type: str, data: Dict[str, Any]) -> bool:
    ...
    async def set_player_status(self, player_name: str, status: str, 
                               drunk: bool = False, poisoned: bool = False) -> bool:
    ...
    async def add_reminder_token(self, player_name: str, token_type: str, description: str) -> bool:
    ...
    def get_supported_features(self) -> List[str]:
        ...
        base_features = [
            "connect", "listen_events", "announce_phase", 
            "announce_death", "announce_execution"
        ]
        
        if self.platform == "clocktower_online":
            return base_features + [
                "create_room", "private_info", "wake_player", 
                "set_status", "reminder_tokens"
            ]
        elif self.platform == "botc_app":
