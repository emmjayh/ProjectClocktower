...
class TestStorytellerAI:
    ...
    def sample_game_state(self):
        ...
        players = [
            Player(id="1", name="Alice", seat_position=0, character="Fortune Teller", team=Team.GOOD),
            Player(id="2", name="Bob", seat_position=1, character="Empath", team=Team.GOOD), 
            Player(id="3", name="Charlie", seat_position=2, character="Chef", team=Team.GOOD),
            Player(id="4", name="Diana", seat_position=3, character="Poisoner", team=Team.EVIL),
            Player(id="5", name="Eve", seat_position=4, character="Imp", team=Team.EVIL)
        ]
    ...
    def test_monk_protection_selection(self, storyteller_ai, sample_game_state):
        ...
        monk = Player(id="6", name="Frank", seat_position=5, character="Monk", team=Team.GOOD)
